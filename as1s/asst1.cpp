...
struct ShaderState {
	...
	ShaderState(const char* vsfn, const char* fsfn) {
		...
		cout<<safe_glGetAttribLocation(h, "fragColor");
...
static void display(void) {
	...
	//|_____________________________________|
	//
	// Access the uX in the vshader and set value depending on the longer axis
	//
	glUniform1i(safe_glGetUniformLocation(curSS.program, "uX"), g_width > g_height ? 1 : 0);
	g_objScale = g_width > g_height ? g_height * 1.0 / g_width : g_width * 1.0 / g_height;

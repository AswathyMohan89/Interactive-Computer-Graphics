...
static int g_skyWorld = 0; // currently sky-sky
...
static Matrix4 g_curObjRbt = g_eyeRbt;
// ============================================
...
static void drawStuff() {
	...
	// ===============================
	const Matrix4 eyeRbt = g_curObjRbt;
	...
	if (g_mouseClickDown) {
		...
		if(g_objIndex == 0) {
			if(g_viewIndex != 0) cout<<"Cannot transform Sky from Cube view"<<endl;
				...
				Matrix4 wrt = g_skyWorld == 0 ? g_eyeRbt : Matrix4::makeTranslation(Cvec3(0, 0, 0));
				Matrix4 A = transFact(wrt) * linFact(wrt);
				// Matrix4 A = transFact(g_eyeRbt) * linFact(g_eyeRbt);
				g_eyeRbt = A * inv(m) * inv(A) * g_eyeRbt;
			}
		}
		else {
			Matrix4 t = g_objectRbt[g_objIndex - 1];
			Matrix4 A = transFact(t) * linFact(g_curObjRbt);   // transform the any given object with respect to curObj View
...
static void keyboard(const unsigned char key, const int x, const int y) {
	...
	case 'o':
		...
		switch (g_objIndex)
		{
		case 0: cout<<"Current Object: Sky"<<endl;    break;  // Sky    as Current Object
		case 1: cout<<"Current Object: Cube 1"<<endl; break;  // Cube 1 as Current Object
		case 2: cout<<"Current Object: Cube 2"<<endl; break;  // Cube 2 as Current Object
		}
		break;
	case 'm':
		...
		switch (g_skyWorld)
		{
		case 0: cout<<"Current Frame: Sky-Sky";   break;  // Frame as Sky-Sky
		case 1: cout<<"Current Frame: Sky-World"; break;  // Frame as Sky-World
		}
		break;
	case 'r':
		reset();
